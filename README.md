...
We define *LRUCache* to represent the entire cache we need to manage. To achieve the goal of amortized O(1) complexity, we utilize two key data structures: 
...
- [75 pts] Functional Requirements:
	...
	- O(1) complexity - you get the pts if you lru-test7 produce similar results as the provided results. - /15
